	...
	namespace Exchange
	{
		...
		struct EXTERNAL IMiracastService : virtual public Core::IUnknown
		{
            ...
            struct EXTERNAL INotification : virtual public Core::IUnknown
            {
				...
				virtual void OnClientConnectionRequest(const string &clientMac, const string &clientName) {};
				...
				virtual void OnClientConnectionError(const string &clientMac, const string &clientName, const string &errorCode, const string &reason) {};
			...
			// @param success: Is the operation successful or not
			virtual Core::hresult StopClientConnection(const string &clienMac /* @in */, const string &clienName /* @in */, Result &success /* @out */) = 0;
			...
			// @param success: Is the operation successful or not
			virtual Core::hresult UpdatePlayerState(const string &clienMac /* @in */, const string &playerState /* @in */, const PlayerReasonCode &reasonCode /* @in */, const string &reason /* @in */, Result &success /* @out */) = 0;
