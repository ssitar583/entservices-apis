...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICESETTINGS_MANAGER                            = ID_ENTOS_OFFSET + 0x3E0,
        ID_DEVICESETTINGS_MANAGER_HDMIHOTPLUG_NOTIFICATION   = ID_DEVICESETTINGS_MANAGER + 1,
        ID_DEVICESETTINGS_MANAGER_RXSENSE_NOTIFICATION       = ID_DEVICESETTINGS_MANAGER + 2,
        ID_DEVICESETTINGS_MANAGER_HDCP_STATUS_NOTIFICATION   = ID_DEVICESETTINGS_MANAGER + 3,
        ID_DEVICESETTINGS_MANAGER_AUDIO_NOTIFICATION         = ID_DEVICESETTINGS_MANAGER + 4,
        ID_DEVICESETTINGS_MANAGER_HDMIIN_NOTIFICATION        = ID_DEVICESETTINGS_MANAGER + 5,
        ID_DEVICESETTINGS_MANAGER_VIDEOPORT_NOTIFICATION     = ID_DEVICESETTINGS_MANAGER + 6,
        ID_DEVICESETTINGS_MANAGER_VIDEODEVICE_NOTIFICATION   = ID_DEVICESETTINGS_MANAGER + 7,
        ID_DEVICESETTINGS_MANAGER_HOST_NOTIFICATION          = ID_DEVICESETTINGS_MANAGER + 8,
        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN_NOTIFICATION   = ID_DEVICESETTINGS_MANAGER + 9,
        ID_DEVICESETTINGS_MANAGER_FPD_NOTIFICATION           = ID_DEVICESETTINGS_MANAGER + 10
