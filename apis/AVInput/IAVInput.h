...
namespace WPEFramework
{
    namespace Exchange
    {
        ...
        struct EXTERNAL IAVInput : virtual public Core::IUnknown
        {
            ...
            virtual Core::hresult getInputDevices(InputDeviceType type /* @in */, IInputDeviceIterator*& devices /* @out */) = 0;
            ...
            virtual Core::hresult stopInput(InputDeviceType type /* @in */) = 0;
            ...
            virtual Core::hresult setVideoRectangle(uint16_t x /* @in */, uint16_t y /* @in */, uint16_t width /* @in */, uint16_t height /* @in */, InputDeviceType type /* @in */) = 0;
