...
<a name="head.PowerManager_Plugin"></a>
# PowerManager Plugin
...
- [org.rdk.PowerManager.json](https://github.com/rdkcentral/ThunderInterfaces/blob/master/interfaces/org.rdk.PowerManager.json)
...
| [getPowerState](#method.getPowerState) | Returns the current power state of the device |
| [getThermalState](#method.getThermalState) | Returns temperature threshold values |
...
| [getLastWakeupReason](#method.getLastWakeupReason) | Returns the reason for the device coming out of deep sleep |
...
| [setWakeupSrcConfig](#method.setWakeupSrcConfig) | Sets the wakeup source configuration for the input powerState |
| [getWakeupSrcConfig](#method.getWakeupSrcConfig) | Returns all the supported wakeup configurations and powerState |
| [setSystemMode](#method.setSystemMode) | Sets the mode of the set-top box for a specific duration before returning to normal mode |
...
<a name="method.getThermalState"></a>
...
| Event | Description |
| :-------- | :-------- |
| [onPowerModeChanged](#event.onPowerModeChanged) | Triggers when the system power state changes. The power state (must be one of the following: *OFF*, *STANDBY*, *ON*, *LIGHT_SLEEP*, *DEEP_SLEEP*) |
### Parameters
...
<a name="method.getLastWakeupReason"></a>
...
| Event | Description |
| :-------- | :-------- |
| [onRebootBegin](#event.onRebootBegin) | Triggers when a device reboot request is made |
### Parameters
...
<a name="method.setWakeupSrcConfig"></a>
...
<a name="method.getWakeupSrcConfig"></a>
...
| Event | Description |
| :-------- | :-------- |
| [onRebootBegin](#event.onRebootBegin) | Triggered when an application invokes the reboot method |
| [onPowerModeChanged](#event.onPowerModeChanged) | Triggered when the power manager detects a device power state change |
| [onPowerModePreChange](#event.onPowerModePreChange) | Triggered before change then device power state |
| [onDeepSleepTimeout](#event.onDeepSleepTimeout) | Triggered when the power manager detects a device power state change to light sleep from deep sleep |
| [onNetworkStandbyModeChanged](#event.onNetworkStandbyModeChanged) | Triggered when the network standby mode setting changes |
| [onThermalModeChanged](#event.onThermalModeChanged) | Triggered when the device temperature changes beyond the `WARN` or `MAX` limits (see `setTemperatureThresholds`) |


<a name="event.onRebootBegin"></a>
...
<a name="event.onPowerModeChanged"></a>
...
<a name="event.onPowerModePreChange"></a>
...
<a name="event.onDeepSleepTimeout"></a>
...
<a name="event.onThermalModeChanged"></a>
