...
| Event | Description |
| :-------- | :-------- |
| [statechange](#event.statechange) | Triggered if the state of the service changes. |
### Value
...
| Event | Description |
| :-------- | :-------- |
| [urlchange](#event.urlchange) | Triggered if the URL changes in the browser |
...
| Event | Description |
| :-------- | :-------- |
| [visibilitychange](#event.visibilitychange) | Triggered if the urlchange event returns false as URL failed to load |
### Value
