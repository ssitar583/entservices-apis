...
| Event | Description |
| :-------- | :-------- |
| [onFiveDigitCodeLoad](#event.onFiveDigitCodeLoad) | Triggered if new five digit codes are loaded successfully |
### Parameters
...
| Event | Description |
| :-------- | :-------- |
| [onIRCodeLoad](#event.onIRCodeLoad) | Triggered if new IR codes are loaded successfully |
### Parameters
