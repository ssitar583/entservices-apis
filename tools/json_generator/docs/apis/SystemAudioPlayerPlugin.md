...
| [getPlayerSessionId](#method.getPlayerSessionId) | Gets the session ID from the provided the URL |
...
| [setSmartVolControl](#method.setSmartVolControl) | Sets the smart volume audio control on the specified player |
...
| Event | Description |
| :-------- | :-------- |
| [onsapevents](#event.onsapevents) | Triggered if the playback paused on the specified player. |
### Parameters
...
| Event | Description |
| :-------- | :-------- |
| [onsapevents](#event.onsapevents) | Triggered if the playback is started to play or finished normally on the specified player. |
### Parameters
...
| Event | Description |
| :-------- | :-------- |
| [onsapevents](#event.onsapevents) | Triggered if the buffer needs more data to play. |
### Parameters
...
| Event | Description |
| :-------- | :-------- |
| [onsapevents](#event.onsapevents) | Triggered if the playback resumed on the specified player. |
### Parameters
...
<a name="method.setSmartVolControl"></a>
