...
<a name="head.MiracastPlayer_Plugin"></a>
...
| [setPlayerState](#method.setPlayerState) | To set the Miracast Player to STOP/PLAY/PAUSE |
| [setVideoRectangle](#method.setVideoRectangle) | Set the Video Rectangle |
| [setRTSPWaitTimeout](#method.setRTSPWaitTimeout) | Set the RTSP Socket Receive timeout for M1-M7 messages |
| [setLogging](#method.setLogging) | Enable/Disable/Reduce the Logging level for Miracast |
| [setVideoFormats](#method.setVideoFormats) | Set the Video formats for RTSP capability negotiation |
| [setAudioFormats](#method.setAudioFormats) | Set the Audio formats for RTSP capability negotiation |


<a name="method.playRequest"></a>
...
<a name="method.setPlayerState"></a>
## *setPlayerState [<sup>method</sup>](#head.Methods)*
...
<a name="method.setRTSPWaitTimeout"></a>
## *setRTSPWaitTimeout [<sup>method</sup>](#head.Methods)*
...
<a name="method.setLogging"></a>
## *setLogging [<sup>method</sup>](#head.Methods)*
...
<a name="method.setVideoFormats"></a>
## *setVideoFormats [<sup>method</sup>](#head.Methods)*
...
<a name="method.setAudioFormats"></a>
## *setAudioFormats [<sup>method</sup>](#head.Methods)*
...
| Event | Description |
| :-------- | :-------- |
| [onStateChange](#event.onStateChange) | Triggered when the Miracast Player Plugin changes the states |
