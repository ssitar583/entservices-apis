...
| [onError](#event.onError) | Triggered when device fails to cancel the in-progress WPS pairing. |
### Parameters
...
| [onError](#event.onError) | Triggered when WPS pairing fails. |
### Parameters
...
| Event | Description |
| :-------- | :-------- |
| [onWifiSignalThresholdChanged](#event.onWifiSignalThresholdChanged) | Triggered when Wifi signal strength switches between Excellent, Good, Fair, Weak. |
### Parameters
